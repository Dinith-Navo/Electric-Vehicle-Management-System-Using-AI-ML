...
class ChargingTimeService:
    ...
    def calculate_charging_time(req: ChargingEstimateRequest) -> ChargingEstimateResult:
        ...
        # Fast Charging Curve Adjustment Factor:
        # Lithium-ion batteries charge rapidly between 10%-80%, then throttle significantly above 80% to protect cells.
        curve_factor = 1.0
        if target_soc > 80.0:
            # Portion above 80% takes ~1.5x longer due to CC/CV transition
        ...
        # Base hours required = Energy / Power
