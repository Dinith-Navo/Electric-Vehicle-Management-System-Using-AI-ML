...
from ..range_prediction.range_prediction.service import RangePredictionService
from ..charging_stations.charging_station.service import ChargingStationService
from ..cost_analysis.cost.service import CostAnalysisService
...
class DashboardService:
    ...
    async def get_dashboard_data(user_lat: float = 6.9271, user_lon: float = 79.8612) -> DashboardOverviewData:
        ...
        try:
            ...
            logger.debug(f"Telemetry/vehicle fetch exception: {e}")

        # 2. Compute live Range Prediction
        ...
        # 3. Fetch Nearby & Recommended Stations
